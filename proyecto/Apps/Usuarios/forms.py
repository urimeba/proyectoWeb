...
class ActualizarDatos(forms.Form):
    ...
    nombre = forms.CharField(widget=forms.TextInput(attrs={'class':'form__input', 'placeholder':'Nombre:', 'name':'nombre','minlength':'1'}))
    apellido = forms.CharField(widget=forms.TextInput(attrs={'class':'form__input', 'placeholder':'Apellido(s):', 'name':'apellido','minlength':'1'}))
